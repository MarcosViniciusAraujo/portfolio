...
export const profile: Profile = {
  ...
  socials: {
    github: "https://github.com/MarcosViniciusAraujo",
    linkedin: "https://www.linkedin.com/in/marcos-vinicius-araujo",
    email: "m.v.araujo.almeida@gmail.com",
  },
  skills: [
    { name: "LLM Agents", category: "ai" },
    { name: "RAG Architectures", category: "ai" },
    { name: "LangChain", category: "ai" },
    { name: "Langfuse", category: "ai" },
